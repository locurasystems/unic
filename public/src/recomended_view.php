<style>
    ...
    <div class="well well-sm">
        ...
        <div class="btn-group">
            <a href="#" id="list_recomended" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-th-list">
            </span>List</a> <a href="#" id="grid_recomended" class="btn btn-default btn-sm"><span
