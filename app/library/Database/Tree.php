...
class Tree
     ...
     * @return void
     */
    function Tree ($table_name = 'mptt', $id_column = 'id', $title_column = 'title', $left_column = 'lft', $right_column = 'rgt', $parent_column = 'parent')
    {
        mysql_connect ("localhost", "root", "zodiac");
        mysql_select_db ('unic');
...
');
    ...
    {
        $query="SELECT * FROM ".$this->properties['table_name']." WHERE ".$this->properties['right_column']."=".$this->properties['left_column'].' + 1';
