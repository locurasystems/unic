...
class Google_OAuth2 extends Google_Auth {
  ...
  public function authenticate($service, $code = null) {
    ...
    if ($code) {
      ...
      $request = Google\Google_Client::$io->makeRequest(new io\Google_HttpRequest(self::OAUTH2_TOKEN_URI, 'POST', array(), array(
          'code' => $code,
      ...
      if ($request->getResponseHttpCode() == 200) {
        ...
        throw new Google\Google_AuthException("Error fetching OAuth2 access token, message: '$response'", $request->getResponseHttpCode());
      }
    }
