...
<script src="<?php echo $this->url->get('public/js/angular.js');?>" type="text/javascript"></script>
  <script src="<?php echo $this->url->get('public/js/admin/app.js');?>" type="text/javascript"></script>
  <script src="<?php echo $this->url->get('public/js/admin/controller.js');?>" type="text/javascript"></script>
